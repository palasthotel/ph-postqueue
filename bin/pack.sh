#!/bin/sh
# Stages public/ in build/postqueue/ - exactly what is deployed to
# WordPress.org - and zips it to postqueue.zip in the project root.
#
...
if [ ! -f "$PROJECT_PATH/public/dist/editor.js" ]; then
